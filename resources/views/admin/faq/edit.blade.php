...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Modifier Question/Réponse</div>
        </div>
        <!--end breadcrumb-->
        <div class="container">
            <div class="main-body">
                            ...
                            <input type="hidden" name="id" value="{{ $faqs->id }}"/>
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="question" class="form-control" value="{{ $faqs->question }}"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="answer" class="form-control" value="{{ $faqs->answer }}"/>
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#myForm').validate({
            ...
            messages: {
                brand_name: {
                    required : 'Inscrire le nom du Brand',
                },
            },
            errorElement: 'span',
