                    ...
                    <div class="col-md-3">
                        <div class="dashboard-menu">
                            <ul class="nav flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="address-tab" data-bs-toggle="tab" href="#address" role="tab" aria-controls="address" aria-selected="true"><i class="fi-rs-marker mr-10"></i>Adresses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="account-detail-tab" data-bs-toggle="tab" href="#account-detail" role="tab" aria-controls="account-detail" aria-selected="true"><i class="fi-rs-user mr-10"></i>Détails de compte</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="change-password-tab" data-bs-toggle="tab" href="#change-password" role="tab" aria-controls="change-password" aria-selected="true"><i class="fi-rs-key mr-10"></i>Mot de passe</a>
                                </li>
                                <li class="nav-item">
                                                ...
                                                <form method="post"  action="{{ route('user.billing.update') }}" name="enq">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input required="" class="form-control" name="billing_province" type="text" value="{{ $userData->billing_province }}" />
                                                        </div>
                                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="{{ route('user.shipping.update') }}" name="enq">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Province<span class="required">*</span></label>
                                                            <input required="" class="form-control" name="shipping_province" type="text" value="{{ $userData->shipping_province }}" />
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Pays<span class="required">*</span></label>
