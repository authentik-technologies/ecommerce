...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span></span><a href="{{ url('/boutique') }}" rel="nofollow">Boutique</a> <span></span> Comparaison
        </div>
    </div>
</div>
<div class="container mb-80 mt-50">
    <div class="row">
        <div class="col-xl-10 col-lg-12 m-auto">
            <h1 class="heading-2 mb-10">Comparer nos produits</h1>
            <h6 class="text-body mb-40">Produits du Québec, rendu disponible via <span class="text-brand">Plancher Laurentides</span></h6>
