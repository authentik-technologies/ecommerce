        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    ...
                    @endphp
                    <li>
                        <a href="{{ url('produits/categories/'.$brand->id.'/'.$brand->brand_slug) }}"> <img src="{{ asset($brand->brand_image) }}" alt="" />{{ $brand->brand_name }}</a><span class="count">{{ count($products) }}</span>
                    </li>
                    @endforeach
                </ul>
            </div>
